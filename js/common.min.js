...
$(function () {     
    ...
    for (key in ELEMENTS_INC) {
        addListNode("included_list", ELEMENTS_INC[key].id, ELEMENTS_INC[key].src, key, ELEMENTS_INC[key].title);
    }
    ...
    var grid = 165;
    var canvasHeight = grid * window.clength;
    var canvasWidth = grid * window.cwidth;
    var _mouseX, _mouseY, _json_type, json_rect;

    var zoom = 1;
    if(canvasHeight > 825 || canvasWidth > 825 ){
        zoomH = canvasHeight / 825;
        zoomW = canvasWidth / 825;
